...
class kurir_proses extends CI_Controller {
	...
	{
		$query = $this->db->query("SELECT * FROM ORDERS_VIEW2 WHERE STATUS = 'Menunggu Kurir'");
        $hasil = $query->result();
		...
		$this->load->view('Kurir/kurir_proses', $data);
