            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href="<?= base_url('index.php/user_order'); ?>"><i class="fa fa-trash"></i> Setor </a> </li>
                  ...
                  <li><a href="<?= base_url('index.php/user_history_redeem'); ?>"><i class="fa fa-credit-card"></i> History Redeem </span></a> </li>
